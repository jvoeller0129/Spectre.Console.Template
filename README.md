# Spectre.Console Template

A .NET `dotnet new` template for building interactive console applications with [Spectre.Console](https://spectreconsole.net) and optionally [Spectre.Console.Cli].
